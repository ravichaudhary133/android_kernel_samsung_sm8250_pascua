...
make O=/home/skye/bomb/out ARCH=arm64 LLVM=1 LLVM_IAS=1 "${MAKE_OPT[@]}" vendor/kona-sec-perf_defconfig vendor/samsung/gts7xl.config
...
cd AnyKernel3
rm *.zip
#zip -r9 ${KERNEL_NAME}$(date +"%Y%m%d")+gts7xl.zip .
